...
public class StringUtilsTest {
  ...
  public void testMentionStrip() {
    ...
    assertEquals(content, StatusUtils.removeMentions(user + tweet));
  }

  @Test
  public void testMatchesBowlingFormat() {
    String tweet = "@Test John 6 2 7 1 10 9 0 8 2 10 10 3 5 7 2 5 5 8";
    assertTrue(StatusUtils.matchesBowlingScoreFormat(tweet));
  }
  ...
  public void testDeosntMatchBowlingFormat() {
    ...
    assertFalse(StatusUtils.matchesBowlingScoreFormat(tweet));
  }
